...
Level.prototype.obstacleAt = function (pos, size) {
  ...
  // check each position starting at yStart, xStart for possible obstacles
...
// Move is there is no wall there
if (obstacle != "wall")
    this.pos = newPos;
};
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  // only allow players to jump while on ground
  if (obstacle) {
